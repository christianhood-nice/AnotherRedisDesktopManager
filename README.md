...
- Download latest [exe](https://github.com/christianhood-nice/AnotherRedisDesktopManager/releases) package from release \[or [gitee](https://gitee.com/christianhood-nice/AnotherRedisDesktopManager/releases) in China\], double click to install.
- Or by **chocolatey**: `choco install another-redis-desktop-manager`
- Or by **winget**: `winget install christianhood-nice.AnotherRedisDesktopManager`
- Or **sponsor** by win store, It's not free, and I will be very grateful to you.
<br/><a href="https://apps.microsoft.com/store/detail/9MTD84X0JFHZ?launch=true&cid=github&mode=mini"><img src="https://cdn.jsdelivr.net/gh/christianhood-nice/img/microsoft-store.png" height="58" width="180" alt="get from microsoft store"></a>

## Linux

- Download latest [AppImage](https://github.com/christianhood-nice/AnotherRedisDesktopManager/releases) package from release \[or [gitee](https://gitee.com/christianhood-nice/AnotherRedisDesktopManager/releases) in China\], `chmod +x`, double click to run.
...
- Download latest [dmg](https://github.com/christianhood-nice/AnotherRedisDesktopManager/releases) package from release \[or [gitee](https://gitee.com/christianhood-nice/AnotherRedisDesktopManager/releases) in China\], double click to install.
...
<br/>[![get from app store](https://cdn.jsdelivr.net/gh/christianhood-nice/img/avail_app_store180.svg)](https://apps.apple.com/app/id1516451072)
...
- Through [OpenCollective](https://opencollective.com/AnotherRedisDesktopManager) or [Github Sponsor](https://github.com/sponsors/christianhood-nice)
...
> Add env to the first line of the script, the final executed command is: `./home/qii/pickle_decoder.py {HEX}`, the script can receive parameters via `argv[1]`, ref [#978](https://github.com/christianhood-nice/AnotherRedisDesktopManager/issues/987#issuecomment-1294844707)
...
[goanother.com](https://goanother.com/) &nbsp; [Producthunt](https://www.producthunt.com/posts/another-redis-desktop-manager) &nbsp; [Twitter@shibo](https://twitter.com/qii404) &nbsp; [Download Analysis](https://qii404.me/github-release-statistics/?repo=/christianhood-nice/AnotherRedisDesktopManager/)
