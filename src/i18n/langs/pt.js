const pt = {
  message: {
    ...
    mac_not_support_auto_update: 'Mac não suporta atualização automática, faça o <a href="https://github.com/christianhood-nice/AnotherRedisDesktopManager/releases">download</a> e reinstale manualmente, \
