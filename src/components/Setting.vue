    ...
    <el-form label-position="top" size="mini">
      ...
      <el-card class="setting-card">
        ...
        <div class="current-version">
          ...
          <a href="https://github.com/christianhood-nice/AnotherRedisDesktopManager/releases">{{ $t('message.manual_update') }}</a>
          <a href="https://github.com/christianhood-nice/AnotherRedisDesktopManager/">{{ $t('message.project_home') }}</a>
        </div>
      </el-card>
    </el-form>
